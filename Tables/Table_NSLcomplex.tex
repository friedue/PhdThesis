\begin{landscape}
\begin{longtable}{>{\textsf\bgroup}p{2.5cm}<{\egroup} >{\textsf\bgroup}p{2.5cm}<{\egroup} >{\textsf\bgroup}p{16cm}<{\egroup}} % defining the columns - these must match the widths defined for the mini pages down below!
...
\begin{minipage}{2.5cm} % 1st column
				...
				%\vskip 4pt
			\end{minipage}
			& \begin{minipage}{3cm} % 2nd column
				%\vskip 6pt
				coiled coil \\
				PEHE				
				%\vskip 4pt
			\end{minipage} 
					& \begin{minipage}{16cm} % 3rd column
					%	\vskip 6pt
